            ...
            <div>
                ...
                <div className="flex content-center items-center gap-2 h-fit">
                    <input 
                        type="text" 
                        value={new_use} 
                        onChange={(e) => set_new_user(e.target.value)} 
                        className="outline-0 border-2 border-gray-400 bg-gray-300 rounded-[5px] text-[22px] text-gray-900 px-2"
                    />
                    <button 
                        onClick={() => {
                            playSettingSound(); 
                            set_username(new_use);
                        }} 
                        className="
                ...
                <div className="grid grid-cols-[repeat(auto-fill,100px)] gap-6">
                    {osdata.pfp_list.map((pfp) => (
                        ...
                        >
                            ...
                            />
                            <h1 className={`
                                text-gray-800 text-center w-fit px-1 text-[22px] leading-[0.8] transition-all
                ...
                <div className="grid grid-cols-[repeat(auto-fill,100px)] gap-6">
                    {osdata.wallpaper_list.map((wallpaper) => (
                        <div 
                            ...
                            onMouseDown={() => { 
                                playSettingSound(); 
                                set_current_wallpaper(wallpaper.path);
                            }}
                        >
                            <Image 
                                src={wallpaper.path} 
